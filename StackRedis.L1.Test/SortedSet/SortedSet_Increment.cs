...
{
    [TestClass]
    public class SortedSet_Increment : UnitTestBase
    {
        [TestMethod]
        public void SortedSet_Increment_Cached()
        {
        ...
        [TestMethod]
        public void SortedSet_Increment_WithinRange_Cached()
        {
            _memDb.SortedSetAdd("key", new StackExchange.Redis.SortedSetEntry[]
            {
            ...
            range = _memDb.SortedSetRangeByScore("key", 1, 4); //Needs a server request
            Assert.AreEqual(4, CallsByMemDb);
            Assert.AreEqual(3, range.Length);
        }

        [TestMethod]
        public void SortedSet_Increment_NotCached()
        {
